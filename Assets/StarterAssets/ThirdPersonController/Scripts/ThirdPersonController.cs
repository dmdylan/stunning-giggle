...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		private void CameraRotation()
		{
			...
			{
				_cinemachineTargetYaw += _input.LookVector.x * Time.deltaTime * lookXSensitivity;
				_cinemachineTargetPitch += _input.LookVector.y * Time.deltaTime * lookYSensitivity;
			}
		...
		private void Move()
		{
			...
			if (_input.MovementVector == Vector2.zero) targetSpeed = 0.0f;
			...
			Vector3 inputDirection = new Vector3(_input.MovementVector.x, 0.0f, _input.MovementVector.y).normalized;
		...
		private void JumpAndGravity()
		{
			if (Grounded)
			{
				...
				// Jump
				if (_input.Jumped && _jumpTimeoutDelta <= 0.0f)
				{
